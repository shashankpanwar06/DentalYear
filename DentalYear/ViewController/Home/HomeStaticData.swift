...
enum CellType:String {
    ...
    static let allValues = [kHowToCelebrate,kShareWithTeamMember,kDailyMarketingTip,kDailyPost,kHowToMaximizePost,kWeeklyMarketingExercise,kAdOfTheMonth,kMarketingTrendsNews,kThisDateInHistory,kLookingAhead]
